...
Prerequisites:
   ...
   - account 'treasury' is the issuer of DNC token.
...
````
$ cleos multisig propose test '[{"actor": "treasury", "permission": "active"}]' '[{"actor": "treasury", "permission": "active"}]' eosio.token issue '{"to": "tester", "quantity": "1000.0000 DNC", "memo": ""}' -p tester
