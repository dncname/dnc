   ...
   class base_tester {
      public:
                                                       ...
                                                       )
         {
            ...
            for( auto n : names ) traces.emplace_back( create_account( n, N(dnc)/*config::system_account_name*/, multisig, include_code ) );
            return traces;
         }
   		 ...
   		 const char* genesis_string = R"=====(
{
  ...
  "initial_account_list": [{
      ...
      "asset": "1000000000.0000 DNC",
      "name": "dnc"
    },{
      "key": "EOS842ZDGXdExMNiMhLmevmKA3vapRWWfWsskXzRripTsAG8hUk2R",
      "asset": "1000000.0000 DNC",
      "name": "b1"
    },{
      "key": "EOS842ZDGXdExMNiMhLmevmKA3vapRWWfWsskXzRripTsAG8hUk2R",
      "asset": "1000000.0000 DNC",
  ...
  "initial_producer_list": [{
      ...
      "url": ""
	  	 ...
	  	 vcfg.genesis.initial_account_list[0].key = get_public_key( N(dnc), "active" );
	  	 vcfg.genesis.initial_account_list[2].key = get_public_key( N(force.test), "active" );
	  	 vcfg.genesis.initial_producer_list[0].bpkey = get_public_key( N(dnc), "active" );
