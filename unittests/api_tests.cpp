...
/*
   {
      ...
      auto pl = vector<permission_level>{{N(dnc), config::active_name}};
      ...
      act.authorization = {{N(dnc), config::active_name}};
      trx.actions.push_back(act);
      ...
      trx.sign(this->get_private_key(N(dnc), "active"), control->get_chain_id());
