...
[中文](https://github.com/dnc/dnc/blob/master/Docker/README_zh.md)

Simple and fast setup of dnc on Docker is also available.
...
At First, we need to make a config.ini, A simple config.ini is in https://github.com/dnc/dnc/blob/master/Docker/config.ini.
